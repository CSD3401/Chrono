...
DefaultDirName={pf}\DigiPen\Chrono

; Start menu directory
DefaultGroupName=DigiPen\Chrono

; Output directory for the installer.
OutputDir=.\INSTALLER

; Setup executable installer
OutputBaseFilename=Chrono_Setup
...
SetupIconFile=.\INSTALLERFILES\Chrono.ico
...
[Icons]
Name: {group}\Chrono; Filename: {app}\Chrono.exe; WorkingDir: {app}; IconFilename: "{app}\Chrono.ico"
; Name: {group}\Chrono_Windowed; Filename: {app}\ChronoWindowed.exe; WorkingDir: {app}; IconFilename: "{app}\Chrono.ico"
Name: {group}\{cm:UninstallProgram,Chrono}; Filename: {uninstallexe}
Name: {group}\{cm:UninstallProgram,Chrono}; Filename: {uninstallexe};  IconFilename: "{app}\Chrono.ico"
Name: {commondesktop}\Chrono; Filename: {app}\Chrono.exe; Tasks: desktopicon; WorkingDir: {app}; IconFilename: "{app}\Chrono.ico"
; Name: {commondesktop}\Chrono_Windowed; Filename: {app}\ChronoWindowed.exe; Tasks: desktopicon; WorkingDir: {app}; IconFilename: "{app}\Chrono.ico"
...
Filename: {app}\Chrono.exe; Description: {cm:LaunchProgram,Chrono}; Flags: nowait postinstall skipifsilent
